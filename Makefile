...
assets/frontend.css:
	sass --scss -t compressed -Ilib -Iapp/frontend -Ibower_components/bootstrap-sass/assets/stylesheets frontend.scss > assets/frontend.css
...
assets/backend.css:
	sass --scss -t compressed -Ilib -Iapp/backend -Ibower_components/bootstrap-sass/assets/stylesheets backend.scss > assets/backend.css
